  ...
  return (
    <div className="w-full max-w-md mx-auto bg-black p-6 sm:p-8 rounded-2xl text-center text-black mt-10">
      ...
      <div className="flex items-center justify-center gap-6 mb-6">
        ...
        <span className="text-2xl font-bold text-white">{customQuantity || quantity}</span>
        <Button
          variant="outline"
          className="border p-3 rounded-full"
      ...
      {/* Bouton de paiement */}
      <Button
        className="w-full flex items-center justify-center gap-3 text-white font-semibold py-3 rounded-lg shadow-md"
